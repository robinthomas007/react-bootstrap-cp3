    ...
    if (props.editParams && props.editParams.length > 0) {
      ...
      props.editParams.forEach((track) => {
        const labelFacets =
          track.source !== "REP"
            ? props.labelFacets
            : [{ id: track.labelId, name: track.label }];
        const trackObj = {
          ...track,
      ...
      axios
        ...
        .then((res) => {
          if (res.data) {
            ...
            const hasDuplicate = isrcList.some((item) =>
              duplicateIsrcList.includes(item)
            );
            if (!hasDuplicate) {
      ...
      <Modal.Body>
        ...
        >
          <Row className="pb-10">
            ...
            <Col md={1} className="custom-col-padding">
            ...
            <Col className="custom-col-padding" style={{ maxWidth: 150 }}>
              ...
              <Row className="pb-10 pt-10 border-bottom" key={index}>
                ...
                <Col className="custom-col-padding" style={{ maxWidth: '120px' }}>
                  ...
                  >
                    <Form.Control
                      className={
                        duplicateIsrcList.includes(track.isrc) ? "dup-warn" : ""
                      }
                      value={track.isrc}
                      type="text"
                      name="isrc"
                ...
                <Col className="custom-col-padding" style={{ maxWidth: '120px' }}>
                  <Form.Group
                    ...
                    className="d-flex align-items-start flex-direction-column"
                    style={{ width: '120px', marginLeft: 4 }}
                  >
                    <Datepicker
                      disabled={track.source === "REP"}
                ...
                <Col
                  className="d-flex align-items-end justify-content-space-evenly action-icons"
      ...
      <Modal.Footer>
        {duplicateIsrc && (
          <div className="d-flex justify-content-center align-items-center">
            <p className="duplicate-isrc-warn">
              A CP3 record with this ISRC already exists. You can proceed to
              create the duplicate record by hitting the ‘Create Duplicate
              Record’ button below or you can click cancel to return to the
              search screen.
            </p>
          </div>
        )}
